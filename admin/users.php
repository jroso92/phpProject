		...
		if ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2) {
			...
			<form action="" id="registration_form" name="registration_form" method="POST">
				...
				<label for="role">Role:</label>
					...
					<option value=1'; if($row['role'] == 1) {print ' selected ';} print ' >Administrator</option>
					<option value=2'; if($row['role'] == 2) {print ' selected ';} print ' >Editor</option>
					<option value=3'; if($row['role'] == 3) {print ' selected ';} print ' >User</option>
					</select>
